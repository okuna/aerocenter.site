<html>
  <head>
    ...
    <title>Aero Center Non-Radar Clock</title>
...
<nav>
	<ul class = "s4">
		...
		<li><a onclick="pauseTimer()" style = "color: red;">Pause</a></li>
		<li><a onclick="useCurrentTime()">Reset</a></li>
		<li><a onclick="rewind()" style = "color: red;"><<</a></li>
	</ul>
</nav>

<table>
	<tr><td style="text-align:right">JAN</td><td id = "jan"></td><td id = "janMetar"></td></tr>
	<tr><td style="text-align:right">GWO</td><td id = "gwo"></td><td id = "gwoMetar"></td></tr>
	<tr><td style="text-align:right">MLU</td><td id = "mlu"></td><td id = "mluMetar"></td></tr>
	<tr><td style="text-align:right">VKS</td><td id = "vks"></td><td id = "vksMetar"></td></tr>
</table>
</div>
